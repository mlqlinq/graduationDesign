<template>
    <el-button style="margin-left: 1%; margin-bottom: 10px" type="primary" icon="Plus" plain @click="addUser($event)"> 新增 </el-button>
    <el-table
        v-loading="loading"
    ...
    >
        ...
        <el-table-column prop="avatar" label="用户头像" align="center" width="120">
            <template #default="scope">
                <img :src="scope.row.avatar" :alt="scope.row.nick_name + '的头像'" style="width: 75px; height: 75px" />
            </template>
        </el-table-column>
        ...
        <el-table-column align="center" label="操作" min-width="100px">
            <template #default="scope">
                <el-tooltip v-if="scope.row.user_type !== '00'" placement="bottom" content="添加">
                    <el-button type="success" icon="CirclePlus" circle @click="addUser(scope.row)" />
                </el-tooltip>
                <el-tooltip v-if="scope.row.user_type !== '00'" placement="bottom" content="修改">
                    <el-button type="primary" icon="Edit" circle v-if="scope.row.user_type !== '00'" @click="editUser(scope.row)" />
                </el-tooltip>
                <el-tooltip v-if="scope.row.user_type !== '00'" placement="bottom" content="删除">
                    <el-button type="danger" icon="Delete" circle v-if="scope.row.user_type !== '00'" @click="delUser(scope.row)" />
                </el-tooltip>
            </template>
        </el-table-column>
    </el-table>
