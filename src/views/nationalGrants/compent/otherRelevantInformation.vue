<template>
	<div>
		<el-form ref="formRef" :model="form" :rules="formRules" label-width="200px" label-position="right">
			<el-card>
				...
				<div class="card-container">
					<el-card>
						...
						<el-row>
							<el-col :span="8">
								<el-form-item label="辅助说明材料一：">
									<el-upload class="upload-demo" show-file-list :action="upApi + upPath" :on-success="handleAvatarSuccess7" :on-preview="handlePreview" :on-remove="handleRemove" :before-remove="beforeRemove" :limit="1" :on-exceed="handleExceed">
										<el-button type="primary">添加材料</el-button>
										<template #tip>
											<div class="el-upload__tip">请上传图片</div>
										</template>
							...
							<el-col :span="8">
								<el-form-item label="辅助说明材料二：">
									<el-upload class="upload-demo" show-file-list :action="upApi + upPath" :on-success="handleAvatarSuccess8" :on-preview="handlePreview" :on-remove="handleRemove" :before-remove="beforeRemove" :limit="1" :on-exceed="handleExceed">
										<el-button type="primary">添加材料</el-button>
										<template #tip>
											<div class="el-upload__tip">请上传图片</div>
										</template>
							...
							<el-col :span="8">
								<el-form-item label="辅助说明材料三：">
									<el-upload class="upload-demo" show-file-list :action="upApi + upPath" :on-success="handleAvatarSuccess9" :on-preview="handlePreview" :on-remove="handleRemove" :before-remove="beforeRemove" :limit="1" :on-exceed="handleExceed">
										<el-button type="primary">添加材料</el-button>
										<template #tip>
											<div class="el-upload__tip">请上传图片</div>
										</template>
