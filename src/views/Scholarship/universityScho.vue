<template>
	<div class="university">
		...
		<el-card class="tableCard">
			<el-table ref="taskTableRef" :data="universitySchoData" :header-cell-style="{ background: '#e4e8e9', borderColor: '#cfcfcf' }" border height="610px" style="width: 100%" @select="selectClick">
...
const downLoad = async () => {
	await downloadApplicationForm()
		.then((res) => {
			...
			link.href = res.url;
			link.setAttribute("download", "优秀学生奖学金审批表.doc");
